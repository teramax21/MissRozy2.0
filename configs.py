...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 2014972))
	API_HASH = os.environ.get("API_HASH", "e3357d1dc09a6ba338e1be4d07a65395")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6852804171:AAEbJ8tDleN0gdCwRuhQO1NvjrUkxWCcgG0")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "Crazyrosiefsbot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002055789154))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5833644640"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://teramax21:<password>@mvfru.ho6gcgm.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002110830336")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002055789154")
	...
	LP_CHANNEL_USRNM = os.environ.get("mvf4u")
